...
export const TopTabNavigation = () => {
    return (
        <TopTab.Navigator >
            <TopTab.Screen name="unit-description" component={UnitDescription} options={{ tabBarLabel: "المواصفات", tabBarLabelStyle: { fontFamily: "rubik-semi-bold" }, tabBarActiveTintColor: appColors.mainColor, tabBarInactiveTintColor: appColors.blackColor}} />
